...
AggregationFunction::AggregationFunction(PhysicalTypePtr inputType,
    ...
    : inputType(std::move(inputType)), resultType(std::move(resultType)), inputExpression(std::move(inputExpression)),
      inputFieldIdentifier(std::move(inputFieldIdentifier)), resultFieldIdentifier(std::move(resultFieldIdentifier)) {}

AggregationFunction::AggregationFunction(PhysicalTypePtr inputType,
                                         PhysicalTypePtr resultType,
                                         Expressions::ExpressionPtr inputExpression,
                                         Nautilus::Record::RecordFieldIdentifier resultFieldIdentifier)
    : AggregationFunction(std::move(inputType),
                          std::move(resultType),
...
const Nautilus::Record::RecordFieldIdentifier& AggregationFunction::getInputFieldIdentifier() const {
