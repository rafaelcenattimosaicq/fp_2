...
#ifndef NES_EXECUTION_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_INTERVALJOIN_IJBUILDLEFT_HPP_
#define NES_EXECUTION_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_INTERVALJOIN_IJBUILDLEFT_HPP_
 ...
 */
class IJBuildLeft : public IJBuild {

  public:
    IJBuildLeft(const uint64_t operatorHandlerIndex,
  ...
  protected:
    const TimeFunctionPtr timeFunctionOtherSide;
};

}// namespace NES::Runtime::Execution::Operators

#endif// NES_EXECUTION_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_INTERVALJOIN_IJBUILDLEFT_HPP_
