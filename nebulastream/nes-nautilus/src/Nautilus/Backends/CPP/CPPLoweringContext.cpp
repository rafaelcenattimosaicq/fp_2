...
CPPLoweringContext::CPPLoweringContext(std::shared_ptr<IR::IRGraph> ir) : ir(std::move(ir)) {}

std::string CPPLoweringContext::getType(const IR::Types::StampPtr& stamp) {
    if (stamp->isInteger()) {
...
std::stringstream CPPLoweringContext::process() {
...
std::string CPPLoweringContext::process(const std::shared_ptr<IR::BasicBlock>& block, RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::CompareOperation>& cmpOp,
                                 short blockIndex,
                                 RegisterFrame& frame) {
    ...
    // TODO 4974: we have to handle the special case that we want to do a null check. Currently, Nautilus IR just contains a x == 0, thus we check if x is a ptr type.
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::LoadOperation>& loadOp,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::StoreOperation>& storeOp,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(IR::Operations::BasicBlockInvocation& bi, short blockIndex, RegisterFrame& parentFrame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::IfOperation>& ifOpt,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::BranchOperation>& branchOp,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::Operation>& opt, short blockIndex, RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::ProxyCallOperation>& opt,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::NegateOperation>& negateOperation,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
void CPPLoweringContext::process(const std::shared_ptr<IR::Operations::CastOperation>& castOp,
                                 short blockIndex,
                                 RegisterFrame& frame) {
...
std::string CPPLoweringContext::getVariable(const std::string& id) { return "var_" + id; }
